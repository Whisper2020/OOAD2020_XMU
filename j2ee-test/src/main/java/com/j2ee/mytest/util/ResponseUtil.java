...
public class ResponseUtil {
    public static Object ok() {
        ...
        obj.put("errno", com.j2ee.mytest.util.ResponseCode.OK.getCode());
        obj.put("errmsg", com.j2ee.mytest.util.ResponseCode.OK.getMessage());
        return obj;
    }
    ...
    public static Object fail(com.j2ee.mytest.util.ResponseCode code) {
        Map<String, Object> obj = new HashMap<String, Object>();
    ...
    public static Object fail(com.j2ee.mytest.util.ResponseCode code, String errmsg) {
        Map<String, Object> obj = new HashMap<String, Object>();
        obj.put("errno", code.getCode());
